...
public class ClientRestService {
	...
	public Client EnregitrerClient(@RequestBody Client c) {
	...
	public Client ModifierClient(@RequestParam Long id, @RequestParam String nom, @RequestParam String prenom,
			@RequestParam String tel, @RequestParam String email, @RequestParam Date dateNess,
			@RequestParam String paye, @RequestParam String region, @RequestParam String ville,
	...
	public List<Client> EnregitrerLidtClient(@PathVariable List<String> noms, @PathVariable List<String> prenoms,
			@PathVariable List<String> tels, @PathVariable List<String> emails,
			@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) List<Date> dateNess,
			@PathVariable List<String> payes, @PathVariable List<String> regions, @PathVariable List<String> villes,
